...
submit_command="qsub -V -l select=1:ncpus=%s:mem=%smb:scratch_local=%smb -l walltime=%s -m n -o %s.cluster.o -e %s.cluster.e %s" % (job_probs["threads"], job_probs["resources"]["mem_mb"], job_probs["resources"]["disk_mb"], job_probs["resources"]["runtime"], job_probs["log"][0], job_probs["log"][0], jobscript)
